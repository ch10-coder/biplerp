...
const COLUMNS_DEF: Record<string, {id: string, label: string, isRight?: boolean, isNumeric?: boolean, width?: number}[]> = {
    ...
    'PURCHASE': [
        ...
        { id: 'rate', label: 'Rate (Actual)', isRight: true, isNumeric: true, width: 90 },
        { id: 'avgRate', label: 'Avg Rate (Landed)', isRight: true, isNumeric: true, width: 100 },
    ...
    'FULL_LEDGER': [
        ...
        { id: 'actualRate', label: 'Rate (Actual)', isRight: true, isNumeric: true, width: 80 },
        { id: 'rate', label: 'Avg Rate', isRight: true, isNumeric: true, width: 80 },
        ...
        data.materials.forEach(mat => {
            ...
            allActiveBatches.forEach(batch => {
                ...
                exportRows.push({
                    ...
                    uom: mat.unit,
                    qtyIn: batchQty,
                    actualRate: batch.rate || effectiveRate, // Original bill rate (for display only)
                    rate: effectiveRate, // Avg/Landed rate (used for all value calculations)
